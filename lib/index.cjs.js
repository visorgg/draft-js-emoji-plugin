...
var clearEmojiList = function clearEmojiList() {
  Object.keys(MAYHEM_EMOJIS).forEach(function (key) {
    delete object[key];
  });
};
...
var Emoji = function Emoji(_ref) {
  ...
  if (useNativeArt === true) {
    ...
    var emojiObj = mayhemEmojione.emojioneList[_this.props.emoji];
    var shortNameForImage = MAYHEM_EMOJI_CONFIG.getShortnameFromEmoji(emojiObj);
  ...
  _createClass(Entry, [{
    ...
    value: function render() {
      ...
      if (useNativeArt === true) {
        ...
        // short name to image url code steal from emojione source code
        var emojiObj = mayhemEmojione.emojioneList[this.props.emoji];
        var shortNameForImage = MAYHEM_EMOJI_CONFIG.getShortnameFromEmoji(emojiObj);

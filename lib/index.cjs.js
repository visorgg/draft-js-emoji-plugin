...
var MAYHEM_EMOJIS = getMayhemEmojis();
var mayhemEmojione = _objectSpread2({}, emojione, {
...
var Emoji = function Emoji(_ref) {
  ...
  var shortName = mayhemEmojione.toShort(decoratedText);
  ...
  if (useNativeArt === true) {
    ...
    var shortNameForImage = mayhemEmojione.emojioneList[shortName].unicode[mayhemEmojione.emojioneList[shortName].unicode.length - 1];
...
var newEmojiListWithOutPriorityList = function newEmojiListWithOutPriorityList(priorityList) {
  ...
  for (var key in mayhemEmojione.emojioneList) {
  ...
  _createClass(Entry, [{
    ...
    value: function render() {
      ...
      if (useNativeArt === true) {
        ...
        // short name to image url code steal from emojione source code
        var shortNameForImage = mayhemEmojione.emojioneList[this.props.emoji].unicode[mayhemEmojione.emojioneList[this.props.emoji].unicode.length - 1];
  ...
  _createClass(Entry, [{
    ...
    value: function render() {
      ...
      if (useNativeArt === true) {
        ...
        // short name to image url code steal from emojione source code
        var shortNameForImage = mayhemEmojione.emojioneList[emoji].unicode[mayhemEmojione.emojioneList[emoji].unicode.length - 1];
        var fullImagePath = "".concat(imagePath).concat(shortNameForImage, ".").concat(imageType).concat(cacheBustParam);
        emojiDisplay = /*#__PURE__*/React__default.createElement("img", {
          src: fullImagePath,
  ...
  function Group() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderCategory", function (category) {
      ...
      return Object.keys(categoryEmojis).map(function (key) {
        ...
        }, isActive && /*#__PURE__*/React__default.createElement(Entry$1, {
...
var Nav = function Nav(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("ul", {
    ...
    }, /*#__PURE__*/React__default.createElement(Entry$2, {
      theme: theme,
      groupIndex: index,
  ...
  _createClass(EmojiSelect, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("div", {
        ...
        type: "button"
      }, selectButtonContent), /*#__PURE__*/React__default.createElement(Popover, {
        cacheBustParam: cacheBustParam,
        imagePath: imagePath,
        imageType: imageType,
        theme: theme,
...
var unicodeRegex = new RegExp(mayhemEmojione.unicodeRegexp, 'g');
...
var unicodeRegex$1 = new RegExp(mayhemEmojione.unicodeRegexp, 'g');
/*

...
var MAYHEM_EMOJI = {
  ...
  emojiList: {},
  customEmojiMap: {},
  addCustomEmoji: function addCustomEmoji() {}
};
...
var setCustomEmojiMap = function setCustomEmojiMap(customEmojiMap) {
  MAYHEM_EMOJI.customEmojiMap = customEmojiMap;
};
var setCustomEmojiHandler = function setCustomEmojiHandler(callback) {
...
var convertUnicodeToNativeEmoji = function convertUnicodeToNativeEmoji(unicode) {
  ...
  _createClass(Entry, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          id = _this$props.id;
      var className = "".concat(theme.emojiSuggestionsEntry, " ").concat(isFocused ? theme.emojiSuggestionsEntryFocused : "");
      var emojiDisplay = null;
...
var addEmoji = function addEmoji(editorState, emojiShortName) {
  ...
  var emoji = convertUnicodeToNativeEmoji(unicode);
...
var EmojiSuggestions = /*#__PURE__*/function (_Component) {
  ...
  function EmojiSuggestions() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onEmojiSelect", function (emoji) {
      _this.closeDropdown(); // If we hit a custom "emoji", let the app handle it.
  ...
  _createClass(EmojiSuggestions, [{
    ...
    value: function render() {
      ...
      var selection = this.props.store.getEditorState().getSelection();

      var _getSearchText3 = getSearchText(this.props.store.getEditorState(), selection),
          word = _getSearchText3.word;

      this.filteredEmojis = this.getEmojisForFilter();
      var EntryComponent = this.props.customEntryComponent ? this.props.customEntryComponent : Entry;
      ...
      var _this$props = this.props,
          ...
          useNativeArt = _this$props.useNativeArt,
          customEntryComponent = _this$props.customEntryComponent,
          restProps = _objectWithoutProperties(_this$props, ["theme", "ariaProps", "callbacks", "onClose", "onOpen", "onSearchChange", "shortNames", "store", "useNativeArt", "customEntryComponent"]);
      ...
      return /*#__PURE__*/React__default.createElement("div", _extends({}, restProps, {
        ...
        return /*#__PURE__*/React__default.createElement(EntryComponent, {
          key: emoji,
          ...
          emoji: emoji,
          index: index,
          id: "emoji-option-".concat(_this2.key, "-").concat(index),
          theme: theme,
...
var index = (function () {
  ...
  var priorityList = config.priorityList,
      ...
      _config$customEmojiMa = config.customEmojiMap,
      customEmojiMap = _config$customEmojiMa === void 0 ? {} : _config$customEmojiMa,
      customEmojiHandler = config.customEmojiHandler,
      ...
      customEntryComponent = config.customEntryComponent;
  var theme = config.theme ? _objectSpread2(_objectSpread2({}, defaultTheme), config.theme) : defaultTheme; // Update the name getter if possible, this allows us to define what name to use for this image.
  ...
  setCustomEmojiMap(customEmojiMap); // Expose some of this plugins state to the invoker so that they can control some core pieces
